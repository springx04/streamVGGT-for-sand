...
#
# --------------------------------------------------------
# Dataloader for preprocessed tartanair dataset
# See datasets_preprocess/preprocess_tartanair.py
# --------------------------------------------------------
...
class TarTanAirDUSt3R(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='/mnt/disk3.8-4/datasets/tartanair',
                 use_cache = False,
                 dset='Hard',
                 use_augs=False,
                 z_far = 1000,
        ...
        if self.use_cache:
            dataset_location = "/mnt/disk3.8-4/annotations/tartanair_annotations"
            ...
            os.makedirs('/mnt/disk3.8-4/annotations/tartanair_annotations', exist_ok=True)
            self._save_paths_to_json(self.all_rgb_paths, '/mnt/disk3.8-4/annotations/tartanair_annotations/rgb_paths.json')
            self._save_paths_to_json(self.all_depth_paths, '/mnt/disk3.8-4/annotations/tartanair_annotations/depth_paths.json')
            joblib.dump(self.all_extrinsic, '/mnt/disk3.8-4/annotations/tartanair_annotations/extrinsics.joblib')    
            joblib.dump(self.all_intrinsic, '/mnt/disk3.8-4/annotations/tartanair_annotations/intrinsics.joblib')
            joblib.dump(self.rank, '/mnt/disk3.8-4/annotations/tartanair_annotations/rankings.joblib')            
            print('found %d frames in %s (dset=%s)' % (len(self.full_idxs), dataset_location, dset))
