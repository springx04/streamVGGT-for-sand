...
// arrived. This threshold is used only to acquire synchronization; once a
// reliable cycle has been found, packet transport gaps must not split its
// three contiguous source sequences.
