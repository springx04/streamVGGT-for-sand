...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", type=Path, default=repo_root / "checkpoints" / "OmniVGGT.safetensors")
    parser.add_argument("--output-dir", type=Path, default=repo_root / "setc" / "artifacts")
    parser.add_argument(
        "--shapes",
        type=parse_shapes,
    ...
    export_family(args.repo_root, args.checkpoint, args.output_dir, args.shapes)
